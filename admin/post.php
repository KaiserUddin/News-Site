                ...
                <div class="modal-dialog">
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <form action="post.php?do=Insert" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  <label>Meta Tags(Give the meta tags using a blank space)</label>
                  ...
                  <?php }
                    ...
                    if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
                      ...
                      if ( empty($formErrors) ){
                        ...
                        if ( !empty( $imageName ) ){
                            ...
                            if ( $addPost ){
                              $_SESSION['toastr']['messege']    = array("Post published");
                    ...
                    if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
                      ...
                      if ( empty($formErrors) ){
                        ...
                        // Change the Password Only
                          ...
                          if ( $addUser ){
                            $_SESSION['toastr']['messege']    = array("Post updated");
                            $_SESSION['toastr']['alertType']  = "success";
                            header("Location: post.php?do=Manage");
                            exit();
                          }
                    ...
                    if (isset($_GET['delete'])){
                      ...
                      if ( $deletePostData ){
                        $_SESSION['toastr']['messege']    = array("Post deleted successfully");
                        $_SESSION['toastr']['alertType']  = "success";
                        header("Location: post.php?do=Manage");
                        exit();
                      }
